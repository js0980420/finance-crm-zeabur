  ...
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-gray-600 mt-2">管理無效或不符合條件的客戶</p>
      </div>
    </div>
...
const CASE_STATUS_OPTIONS = [
  // 網路進線 (首頁顯示)
  { value: 'pending', label: '待處理', category: 'leads' },

  // 網路進線管理 (4種)
  { value: 'valid_customer', label: '有效客', category: 'leads_management' },
  { value: 'invalid_customer', label: '無效客', category: 'leads_management' },
  { value: 'customer_service', label: '客服', category: 'leads_management' },
  { value: 'blacklist', label: '黑名單', category: 'leads_management' },
